...
const vt = /^(?:[a-z0-9]+:)?\/\//i, bt = /^\/+|(\/)\/+$/g, Fe = "http://sr";
...
function Ve(e) {
  ...
  return Ve(a).reduce((r, s) => [...r, ...o.map((c) => c + s)], []);
}
const Ct = 100, $e = createContext(), pe = createContext(), oe = () => At(useContext($e), "<A> and 'use' router primitives can be only used inside a Route."), Pt = () => useContext(pe) || oe().base, xt = (e) => {
  const t = Pt();
...
function Lt(e, t, n) {
  const a = new URL(Fe), o = createMemo((m) => {
    const f = e();
    try {
      return new URL(f, a);
    } catch {
  ...
  }, a, { equals: (m, f) => m.href === f.href }), r = createMemo(() => o().pathname), s = createMemo(() => o().search, true), c = createMemo(() => o().hash), d = () => "", i = on$1(s, () => ze(o()));
  return { get pathname() {
    return r();
  }, get search() {
    return s();
...
function Dt(e, t, n, a = {}) {
  ...
  }, [u, p] = createSignal(o().value), [k, A] = createSignal(o().state), L = Lt(u, k, s.queryWrapper), R = [], N = createSignal(isServer ? nt() : []), W = createMemo(() => typeof a.transformUrl == "function" ? J(t(), a.transformUrl(L.pathname)) : J(t(), L.pathname)), ke = () => {
    const h = W(), v = {};
    for (let C = 0; C < h.length; C++) Object.assign(v, h[C].params);
    return v;
  }, Ze = s.paramsWrapper ? s.paramsWrapper(ke, t) : He(ke), we = { pattern: m, path: () => m, outlet: () => null, resolvePath(h) {
    return ee(m, h);
  } };
  ...
  function Xe(h, v, C) {
    untrack(() => {
      ...
      const j = !v || v[0] === "?", { replace: K, resolve: _, scroll: Y, state: q } = { replace: false, resolve: !j, scroll: true, ...C }, O = _ ? h.resolvePath(v) : ee(j && L.pathname || "", v);
      if (O === void 0) throw new Error(`Path '${v}' is not a routable path`);
      if (R.length >= Ct) throw new Error("Too many redirects");
      const Se = u();
      if (O !== Se || q !== k()) if (isServer) {
        const Ce = getRequestEvent();
        Ce && (Ce.response = { status: 302, headers: new Headers({ Location: O }) }), r({ value: O, replace: K, scroll: Y, state: q });
      } else i.confirm(O, C) && (R.push({ value: Se, replace: K, scroll: Y, state: k() }), w("navigate", { value: O, state: q }));
    });
  }
  function et(h) {
  ...
  function at(h, v) {
    const C = J(t(), h.pathname), j = D;
    D = "preload";
    for (let K in C) {
      const { route: _, params: Y } = C[K];
      _.component && _.component.preload && _.component.preload();
      const { preload: q } = _;
      v && q && runWithOwner(n(), () => q({ params: Y, location: { pathname: h.pathname, search: h.search, hash: h.hash, query: ze(h), state: null, key: "" }, intent: "preload" }));
    }
    D = j;
  }
  function nt() {
  ...
  const a = createMemo(on$1(e.routerState.matches, (o, r, s) => {
    ...
    for (let i = 0, m = o.length; i < m; i++) {
      ...
      s && f && g.route.key === f.route.key ? d[i] = s[i] : (c = false, t[i] && t[i](), createRoot((b) => {
        t[i] = b, d[i] = Mt(e.routerState, d[i - 1] || e.routerState.base, xe(() => a()[i + 1]), () => {
          var _a2;
...
const xe = (e) => () => createComponent(Show, { get when() {
  return e();
}, keyed: true, children: (t) => createComponent(pe.Provider, { value: t, get children() {
  return t.outlet();
} }) });
function _t(e, t, n) {
  const a = new URL(e.request.url), o = J(n, new URL(e.router.previousUrl || e.request.url).pathname), r = J(n, a.pathname);
...
function Ot(e) {
  let t = false;
  const n = (o) => typeof o == "string" ? { value: o } : o, a = qt(createSignal(n(e.get()), { equals: (o, r) => o.value === r.value && o.state === r.state }), void 0, (o) => (!t && e.set(o), sharedConfig.registry && !sharedConfig.done && (sharedConfig.done = true), o));
  return e.init && onCleanup(e.init((o = e.get()) => {
    t = true, a[1](n(o)), t = false;
  })), Je({ signal: a, create: e.create, utils: e.utils });
}
function Ut(e, t, n) {
...
function Ht(e) {
  let t;
  const n = { value: e.url || (t = getRequestEvent()) && zt(t.request.url) || "" };
  return Je({ signal: [() => n, (a) => Object.assign(n, a)] })(e);
}
...
function Wt(e) {
  ...
  return Ot({ get: t, set({ value: a, replace: o, scroll: r, state: s }) {
    o ? window.history.replaceState(yt(s), "", a) : window.history.pushState(s, "", a), Ft(decodeURIComponent(window.location.hash.slice(1)), r), me();
...
function Ee(e) {
  ...
  const [, t] = splitProps(e, ["href", "state", "class", "activeClass", "inactiveClass", "end"]), n = xt(() => e.href), a = Et(n), o = he(), r = createMemo(() => {
    const s = n();
...
*/
var Gt = { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": 2, "stroke-linecap": "round", "stroke-linejoin": "round" }, U = Gt, Jt = createContext({ size: 24, color: "currentColor", strokeWidth: 2, absoluteStrokeWidth: false, class: "" }), Qt = (e) => {
  ...
  const [t, n] = splitProps(e, ["color", "size", "strokeWidth", "children", "class", "name", "iconNode", "absoluteStrokeWidth"]), a = useContext(Jt);
  return ssrElement("svg", mergeProps(U, { get width() {
    ...
    return !t.children && !Qt(n) ? "true" : void 0;
  } }, n), () => escape(createComponent(For, { get each() {
    return t.iconNode;
  }, children: ([o, r]) => createComponent(Dynamic, mergeProps({ component: o }, r)) })), true);
}, E = Xt, ea = [["path", { d: "M12 7v14", key: "1akyts" }], ["path", { d: "M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z", key: "ruj8y" }]], ta = (e) => createComponent(E, mergeProps(e, { iconNode: ea, name: "book-open" })), aa = ta, na = [["path", { d: "M10 18v-7", key: "wt116b" }], ["path", { d: "M11.119 2.205a2 2 0 0 1 1.762 0l7.84 3.846A.5.5 0 0 1 20.5 7h-17a.5.5 0 0 1-.22-.949z", key: "yxxwt6" }], ["path", { d: "M14 18v-7", key: "vav6t3" }], ["path", { d: "M18 18v-7", key: "aexdmj" }], ["path", { d: "M3 22h18", key: "8prr45" }], ["path", { d: "M6 18v-7", key: "1ivflk" }]], oa = (e) => createComponent(E, mergeProps(e, { iconNode: na, name: "landmark" })), ra = oa, sa = [["rect", { width: "7", height: "9", x: "3", y: "3", rx: "1", key: "10lvy0" }], ["rect", { width: "7", height: "5", x: "14", y: "3", rx: "1", key: "16une8" }], ["rect", { width: "7", height: "9", x: "14", y: "12", rx: "1", key: "1hutg5" }], ["rect", { width: "7", height: "5", x: "3", y: "16", rx: "1", key: "ldoo1y" }]], ia = (e) => createComponent(E, mergeProps(e, { iconNode: sa, name: "layout-dashboard" })), ca = ia, la = [["path", { d: "M4 5h16", key: "1tepv9" }], ["path", { d: "M4 12h16", key: "1lakjw" }], ["path", { d: "M4 19h16", key: "1djgab" }]], da = (e) => createComponent(E, mergeProps(e, { iconNode: la, name: "menu" })), ua = da, ma = [["path", { d: "M13.4 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7.4", key: "re6nr2" }], ["path", { d: "M2 6h4", key: "aawbzj" }], ["path", { d: "M2 10h4", key: "l0bgd4" }], ["path", { d: "M2 14h4", key: "1gsvsf" }], ["path", { d: "M2 18h4", key: "1bu2t1" }], ["path", { d: "M21.378 5.626a1 1 0 1 0-3.004-3.004l-5.01 5.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z", key: "pqwjuv" }]], pa = (e) => createComponent(E, mergeProps(e, { iconNode: ma, name: "notebook-pen" })), ha = pa, fa = [["path", { d: "M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z", key: "1a0edw" }], ["path", { d: "M12 22V12", key: "d0xqtd" }], ["polyline", { points: "3.29 7 12 12 20.71 7", key: "ousv84" }], ["path", { d: "m7.5 4.27 9 5.15", key: "1c824w" }]], ya = (e) => createComponent(E, mergeProps(e, { iconNode: fa, name: "package" })), ga = ya, va = [["path", { d: "M12 3v18", key: "108xh3" }], ["path", { d: "m19 8 3 8a5 5 0 0 1-6 0zV7", key: "zcdpyk" }], ["path", { d: "M3 7h1a17 17 0 0 0 8-2 17 17 0 0 0 8 2h1", key: "1yorad" }], ["path", { d: "m5 8 3 8a5 5 0 0 1-6 0zV7", key: "eua70x" }], ["path", { d: "M7 21h10", key: "1b0cd5" }]], ba = (e) => createComponent(E, mergeProps(e, { iconNode: va, name: "scale" })), Aa = ba, ka = [["circle", { cx: "8", cy: "21", r: "1", key: "jimo8o" }], ["circle", { cx: "19", cy: "21", r: "1", key: "13723u" }], ["path", { d: "M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12", key: "9zh506" }]], wa = (e) => createComponent(E, mergeProps(e, { iconNode: ka, name: "shopping-cart" })), Sa = wa, Ca = [["path", { d: "M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z", key: "1s2grr" }], ["path", { d: "M20 2v4", key: "1rf3ol" }], ["path", { d: "M22 4h-4", key: "gwowj6" }], ["circle", { cx: "4", cy: "20", r: "2", key: "6kqj1y" }]], Pa = (e) => createComponent(E, mergeProps(e, { iconNode: Ca, name: "sparkles" })), xa = Pa, Ea = [["circle", { cx: "12", cy: "8", r: "5", key: "1hypcn" }], ["path", { d: "M20 21a8 8 0 0 0-16 0", key: "rfgkzh" }]], Ra = (e) => createComponent(E, mergeProps(e, { iconNode: Ea, name: "user-round" })), Ta = Ra, Ia = [["path", { d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2", key: "1yyitq" }], ["path", { d: "M16 3.128a4 4 0 0 1 0 7.744", key: "16gr8j" }], ["path", { d: "M22 21v-2a4 4 0 0 0-3-3.87", key: "kshegd" }], ["circle", { cx: "9", cy: "7", r: "4", key: "nufk8" }]], La = (e) => createComponent(E, mergeProps(e, { iconNode: Ia, name: "users" })), Na = La, Da = [["path", { d: "M18 6 6 18", key: "1bl5f8" }], ["path", { d: "m6 6 12 12", key: "d8bk6v" }]], Ma = (e) => createComponent(E, mergeProps(e, { iconNode: Da, name: "x" })), Ba = Ma;
...
const qa = () => Q().idsvcUrl, fe = () => Q().appId, ye = () => `idsvc_refresh_${fe()}`;
let V = null;
const Qe = () => localStorage.getItem(ye()), Oa = (e) => {
  V = e.access, localStorage.setItem(ye(), e.refresh);
}, Ua = () => {
  V = null, localStorage.removeItem(ye());
}, Fa = () => !!Qe();
async function za(e, t) {
  const n = await fetch(`${qa()}${e}`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(t) }), a = await n.json().catch(() => ({}));
...
async function Ha() {
  return G || (G = (async () => {
    ...
    if (!e) return false;
    try {
      const t = await za("/auth/refresh", { refresh: e, app: fe() });
      return Oa(t), true;
    } catch (t) {
...
function ge() {
  if (!V) return null;
  try {
    return JSON.parse(atob(V.split(".")[1].replace(/-/g, "+").replace(/_/g, "/")));
  } catch {
    return null;
  }
}
...
function en() {
  ...
  const e = ge();
  if (!e) return false;
  const t = Q().appId, a = (((_a2 = e.apps) == null ? void 0 : _a2[t]) || Object.values(e.apps || {})[0] || {}).scope || {}, o = a.flags || {}, r = { id: e.sub, uid: e.uid, originalUserId: e.sub, googleUid: e.sub, name: e.name || "", email: e.email || ($ == null ? void 0 : $.email) || "", businessId: a.businessId || "", permissions: { ...o, isAdmin: !!e.superadmin || te(o.isAdmin) }, superadmin: !!e.superadmin, apps: e.apps };
  return Xa(r), true;
}
async function tn() {
  return Fa() ? navigator.onLine ? await Wa() ? (en(), true) : (localStorage.removeItem(ve), $ = null, Ke(), false) : !!$ : false;
}
function an(e) {
  var _a2, _b, _c;
  if (!e) {
  ...
  const n = (_c = (_b = t.apps) == null ? void 0 : _b[Q().appId]) == null ? void 0 : _c.roles;
  return Array.isArray(n) ? n : [];
}
function nn(e) {
  return Ga(an(e), Q().perms);
}
const on = (e) => nn(e).has("*"), be = Ye(), [Ae, rn] = createSignal(be.user), [On, sn] = createSignal(be.loading), [Un, cn] = createSignal(be.error);
Ja(() => {
  const e = Ye();
  rn(e.user), sn(e.loading), cn(e.error);
});
_a({ authBase: "https://ssgloghr.com", idsvcUrl: "https://ssgloghr.com/idsvc", appId: "hrm", clientId: "subpay", perms: { admin: ["*"], accountant: ["journal.post", "journal.void", "payments.record", "payroll.approve", "payroll.post", "accounts.delete", "providers.delete", "inventory.edit", "inventory.delete"], operator: ["inventory.edit", "payments.record"], viewer: [] } });
...
function Rn(e) {
  ...
  const d = (i) => createComponent(Ee, { get href() {
    return i.item.href;
  }, get end() {
    return i.item.href === "/";
  }, get class() {
  ...
  return ssr(Cn, ssrHydrationKey(), ssrAttribute("aria-label", escape(t("common.menu", "Menu"), true), false) + ssrAttribute("aria-expanded", escape(a(), true), false), escape(createComponent(ua, { size: 20 })), escape(t("common.appName", "HRMfinance")), escape(createComponent(Show, { get when() {
    ...
    return ssr(Sn, ssrHydrationKey(), escape(t("nav.groups.admin", "Admin")), escape(createComponent(Ee, { href: "/admin/gemini", end: true, class: "flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900", activeClass: "bg-brand-50 text-brand-700 font-medium", get children() {
      return [createComponent(xa, { size: 17, class: "shrink-0" }), t("admin.geminiUsage", "Gemini Usage")];
    } })));
  } })), escape(t("common.year", "Year")), ssrAttribute("value", escape(hn(), true), false), escape(createComponent(For, { get each() {
    return fn();
  }, children: (i) => ssr(En, ssrHydrationKey() + ssrAttribute("value", escape(i, true), false), escape(i)) })), z.language === "es" ? "EN" : "ES", escape((_a2 = Ae()) == null ? void 0 : _a2.email), escape(t("common.signOut", "Sign out")), escape(e.children));
}
...
//# sourceMappingURL=app-CpPDWuRx.mjs.map
