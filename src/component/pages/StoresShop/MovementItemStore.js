...
if(item){
  classTyp =  item["type"]==="Entrega"?"_Rem":item["type"]==="BTC"?"_btc":item["type"]==="COMBO"?"_cmb":(item["type"]==="INVESTMENT_FOOD" || item["type"]==="INVESTMENT_INGREDIENTS")?"_investFood":  item["type"]==="DEBT"?"_debt":item["type"]==="TRANSFER"?"_trnsfr":"";
  iconTyp =  item["type"]==="Entrega"?"money_outline":item["type"]==="BTC"?"btc_circle":item["type"]==="COMBO"?"food_variant":(item["type"]==="INVESTMENT_FOOD" || item["type"]==="INVESTMENT_INGREDIENTS")?"shopping_outline":item["type"]==="DEBT"?"bank_outline":item["type"]==="TRANSFER"?"bank_transfer":"";
        ...
        <div className={`sendBtn _dsplFlx mov_actions`}>
          ...
          <div className={`sendBtn _dsplFlx spaceAround`}>
            <div className={`fieldPadding _MrgV _actBtnMg`}>
              <span>
              <NavLink  to={{pathname:"/mov_store_details",search:"?movId="+ _id}} className=" u3mD2d xwW5Ce" onClick={_openDtls}>
