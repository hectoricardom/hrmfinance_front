...
const Remesas = loadable(() => import('./remesas'))

const BTC = loadable(() => import('./saleBTC'))

const Transfers = loadable(() => import('./Transfers'))

const Adjust = loadable(() => import('./Adjust'))
...
const SendersComponent = (props) => {
  ...
  var _tabs = ["Transfer","BTC","Envios","Ajuste"]
