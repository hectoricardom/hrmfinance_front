...
import type { InvoiceFormData } from './invoiceFormStore';
...
const DRAFTS_STORAGE_KEY = 'invoice_drafts';
...
const [drafts, setDrafts] = createSignal<InvoiceDraft[]>(loadDraftsFromStorage());

// Export the drafts store
export const invoiceDraftsStore = {
  // Get all drafts
  getDrafts: () => drafts(),
  ...
  // Search drafts by customer name or invoice number
